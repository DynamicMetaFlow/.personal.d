...
(defun my-exwm-keybindings ()
  ...
  (exwm-input-set-key (kbd "s-<tab>") 'my-counsel-ibuffer-by-exwm-class-name)
...
** key-chord
 #+BEGIN_SRC emacs-lisp
   (use-package key-chord
     ...
     (key-chord-define boon-command-map "JJ" 'exwm-jump-to-last-exwm)
...
(key-chord-define-local "jk" #'my-counsel-ibuffer-by-exwm-class-name)
)
