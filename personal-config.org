...
(defun my-exwm-keybindings ()
 ...
 (exwm-input-set-key (kbd "<print>") #'desktop-environment-screenshot)
  ...
  (exwm-input-set-key  (kbd "s-SPC") 'my/switch-to-last-buffer)
  (exwm-input-set-key (kbd "s-\\") 'exwm-jump-to-last-exwm)
  (exwm-input-set-key  (kbd "<s-return>") 'counsel-switch-buffer)
...
╭──────────────────────────────────────────────────────────────────────┴───────╯
  ...
  [_c_] flycheck     [_j_] jump          [_r_] register      [_x_] shell
  [_e_] emacs        [_k_] spell         [_s_] search        [^y^]
  [_f_] file         [_m_] media         [_t_] text          [^z^]
  [_g_] git          [_n_] narrow        [^u^]

--------------------------------------------------------------------------------
    "
  ("\\" my/switch-to-last-buffer "last-buffer")

  ("SPC" counsel-M-x "M-x")
  ("RET" counsel-linux-app "run")
  ("<ESC>" nil "quit")
  ("q" nil "quit")
...
***** Bookmarks
  #+BEGIN_SRC emacs-lisp
(defhydra hydra-bookmarks (:color blue :hint nil :inherit (hydra-common/heads)
                                  :pre (progn
                                         (exwm-input-line-mode))
                                  :post (progn
                                          (exwm-input-char-mode)))
...
╭────────────────────────────────────────────────────────────────────┴─────────╯
  ...
  [_t_] torus              [_w_] save buffer


   ^ ^
--------------------------------------------------------------------------------
    "
  ("a" my/switch-to-last-buffer)
...
╭───────────────────────────────────────────────────────────────────────┴──────╯
  [_f_] open file        [_d_] dired         [_z_] diff dirs
  [_e_] open file extern
--------------------------------------------------------------------------------
      "
  ("f" counsel-find-file)
...
***** organization
  #+BEGIN_SRC emacs-lisp
(defhydra hydra-organization (:color blue :hint nil :inherit (hydra-common/heads)
                                     :pre (progn
                                            (exwm-input-line-mode))
                                     :post (progn
                                             (exwm-input-char-mode)))
...
(defhydra hydra-project (:color blue :hint nil
  ...
  "
   ...
   ╭─────────────────────────────────────────────────────────────────┴────────────╯
     ...
     [_d_] dir           [_S_] replace     [_K_] kill all       [_h_] Helm
...
***** exit
  #+BEGIN_SRC emacs-lisp
(defhydra hydra-exit (:color blue :hint nil :inherit (hydra-common/heads)
                             :pre (progn
                                    (exwm-input-line-mode))
                             :post (progn
                                     (exwm-input-char-mode)))
...
***** torus
  #+BEGIN_SRC emacs-lisp
(defhydra hydra-torus (:color blue :hint nil :inherit (hydra-common/heads)
                                :pre (progn
                                       (exwm-input-line-mode))
                                :post (progn
                                        (exwm-input-char-mode)))
...
╭──────────────────────────────────────────────────────────────────────────────────────────┴─────────╯
  [_SPC_] circle       [_<up>_]   prev-location         [_#_] layout            [_s_] search
  [_=_] location       [_<down>_] next-location         [_c_] add-circle        [_h_] search-history
  [_@_] torus                                         [_l_] add-location
                     [_<left>_]  prev-circle
  [_!_] alt-circle     [_<right>_] next-circle          [_d_] delete-location
  [_<_] alt-circles                                   [_D_] delete-circle
...
("SPC" torus-switch-circle)
("=" torus-switch-location)
("@" torus-switch-torus)

("c" torus-add-circle)
("l" torus-add-location)

("d" torus-delete-location)
("D" torus-delete-circle)

("<up>"   torus-previous-location :color red)
("<down>" torus-next-location     :color red)
("<left>" torus-previous-circle   :color red)
("<right>" torus-next-circle      :color red)


("s" torus-search)
("h" torus-search-history)

("<prior>" torus-history-newer :color red)
("<next>" torus-history-older  :color red)
...
***** window
  #+BEGIN_SRC emacs-lisp
(defhydra hydra-window (:color blue :hint nil :inherit (hydra-common/heads)
                                :pre (progn
                                       (exwm-input-line-mode))
                                :post (progn
                                        (exwm-input-char-mode)))
