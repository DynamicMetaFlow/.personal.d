...
(define-key boon-command-map (kbd "i")   'boon-set-insert-like-state)

;; Hydras Master / Modes
(define-key boon-command-map (kbd ",") 'hydra-master/body)
...
(define-key boon-command-map (kbd "e")   'er/expand-region)
...
(define-key boon-command-map (kbd "a")   'hydra-applications/body)
...
;; Non-Hydra Commands
(define-key boon-command-map (kbd "f")   'counsel-find-file)
...
(define-key boon-command-map (kbd "o")   'em-insert-line-below)
...
;; (define-key boon-command-map "g" '("g magit" . magit-
                                   status))
...
;(define-key boon-command-map (kbd "x")   'delete-forward-char)
...
(defhydra hydra-window (
  ...
  "
                                                                     ╭─────────┐
  Window           Switch                    Do                      │  Window │
╭────────────────────────────────────────────────────────────────────┴─────────╯
     ↑            [_si_] ibuffer           [_dw_] delete window
     _i_            [_sp_] projectile        [_do_] delete other windows
 ← _k_   _l_ →        [_se_] exwm              [_ds_] swap
     _o_            [_sb_] bookmarks         [_g_] grid
     ↓                                   [_st_] torus
...
"
                                                                         ...
                                                                         │ Home  │
╭────────────────────────────────────────────────────────────────────────┴───────╯
  [_o_] Organization   [_p_] Projects   [_f_] Files   [_e_] Emacs
...
(defhydra hydra-organization (
 ...
 ╭───────────────────────────────────────────────────────────────┴──────────────╯
   ...
   [_d_] calendar    [_h_] search headings
    ^ ^              [_f_] archive subtree
    ^ ^
 --------------------------------------------------------------------------------
       "
